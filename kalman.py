...
i2c_address=0x69
bus.write_byte_data(i2c_address,0x20,0x0F)
bus.write_byte_data(i2c_address,0x23,0x20)
addrHMC = 0x1e
...
while True:
    ...
    MAGx = read_word_2c(addrHMC, 3)*0.92
    MAGy = read_word_2c(addrHMC, 7)*0.92
    MAGz = read_word_2c(addrHMC, 5)*0.92

    bus.write_byte(i2c_address,0x28)
    X_L = bus.read_byte(i2c_address)
    bus.write_byte(i2c_address,0x29)
    X_H = bus.read_byte(i2c_address)
    X = X_H << 8 | X_L

    bus.write_byte(i2c_address,0x2A)
    Y_L = bus.read_byte(i2c_address)
    bus.write_byte(i2c_address,0x2B)
    Y_H = bus.read_byte(i2c_address)
    Y = Y_H << 8 | Y_L

    bus.write_byte(i2c_address,0x2C)
    Z_L = bus.read_byte(i2c_address)
    bus.write_byte(i2c_address,0x2D)
    Z_H = bus.read_byte(i2c_address)
    Z = Z_H << 8 | Z_L
